...
<div class="containerLogin clearfix">
  <div class="clearfix" style="height:100%;">
     ...
     <div class="right" id="rightDiv">
        <div class="login" style="dis play:none">
            <h1>Welcome Back</h1>
    ...
    <div class='left' id="leftDiv">
        <div class="login" style="display:none">
            ...
            <form method="post" action="{{ route('dologinDeveloper')}}">
                {{csrf_field()}}
        ...
        <div class="register" style="di splay:none">
...
$(".link").click(function() {
    ...
    $('.right .register .link').addClass("link1");
...
$(document).on('click','.link1',function() {
    ...
    $('.right .register .link').addClass("link");
